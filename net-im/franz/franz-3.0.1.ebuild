...
URL_64="https://github.com/imprecision/franz-app/releases/download/${PV}/${MY_PN}-linux-x64-${PV}.tgz"
URL_32="https://github.com/imprecision/franz-app/releases/download/${PV}/${MY_PN}-linux-ia32-${PV}.tgz"
