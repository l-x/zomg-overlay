...
URL_64="https://github.com/saenzramiro/${PN}/releases/download/${PV}/${MY_PN}-linux-x64.zip"
URL_32="https://github.com/saenzramiro/${PN}/releases/download/${PV}/${MY_PN}-linux-ia32.zip"
